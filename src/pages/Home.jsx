      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          >
            <Link
              to="/dashboard"
              className="card-neu p-3 rounded-xl hover:shadow-glow transition-all duration-300 group flex items-center space-x-2"
            >
              <BarChart3 className="h-6 w-6 text-primary group-hover:text-primary-light transition-colors" />
