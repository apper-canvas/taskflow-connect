        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <Link
                to="/dashboard"
                className="p-3 rounded-xl bg-gradient-to-br from-surface-100 to-surface-200 dark:from-surface-700 dark:to-surface-800 shadow-neu-light hover:shadow-glow transition-all duration-300 group flex items-center gap-2"
              >
                <ApperIcon name="BarChart3" className="h-6 w-6 text-primary group-hover:text-primary-light transition-colors" />
                <span className="hidden sm:inline text-sm font-medium text-surface-700 dark:text-surface-300 group-hover:text-primary transition-colors">Dashboard</span>
              </Link>
            </motion.div>
