      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          >
            <Link
              to="/dashboard"
              className="flex items-center space-x-2 px-4 py-3 rounded-xl card-neu hover:shadow-glow transition-all duration-300 group"
            >
              <BarChart3 className="h-5 w-5 text-primary group-hover:text-primary-light transition-colors" />
              <span className="text-sm font-medium text-surface-700 dark:text-surface-300 group-hover:text-primary transition-colors">
                Dashboard
              </span>
            </Link>
          </motion.div>
